// create-payment-skip — DISABLED.
//
// PokeSwap does not take web payments for now (product decision, 2026-09-24).
// This used to start MercadoPago and PayPal checkouts to skip the PokeSwap
// cooldown; it now answers every request with an explicit 503 and contacts no
// provider, reads no secret and writes nothing.
//
