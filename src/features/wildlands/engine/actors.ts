 ...
 *
 * `beginStep` runs right before each step starts, including steps chained
 * without stopping, so the caller can latch the pace for exactly that tile.
 */
