...
export const STREET_PROP_KINDS: readonly StreetPropKind[] = ['lamp', 'sign', 'bench', 'benchLeft', 'benchShort', 'benchAcross', 'hedge', 'fenceH', 'fenceV']
...
export function tilesOf(city: LabCity, ref: EntityRef): Tile[] {
  ...
  if (ref.type === 'prop') {
    ...
    // Benches cover several tiles from their (tx, ty).
