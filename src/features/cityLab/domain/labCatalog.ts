...
export const PALETTE: readonly PaletteEntry[] = [
  ...
  { kind: 'bench', label: 'Banco largo ▐', group: 'Bancos de plaza' },
  { kind: 'benchLeft', label: 'Banco largo ▌', group: 'Bancos de plaza' },
  { kind: 'benchShort', label: 'Banco corto', group: 'Bancos de plaza' },
  { kind: 'benchAcross', label: 'Banco ─', group: 'Bancos de plaza' },
