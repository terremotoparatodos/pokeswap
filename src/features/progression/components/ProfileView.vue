<template>
  <main class="profile-view">
    ...
    <template v-else-if="profile">
      ...
      <!-- My Pokémon live in their own panel (Mi caja) -->
      <section class="profile-box-link">
        <router-link :to="{ name: 'caja' }" class="profile-link">Ver mi caja →</router-link>
      </section>
