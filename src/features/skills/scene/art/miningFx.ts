...
/**
 * Thought-bubble pictograms over a workable node: what *kind* of work it is
 * (break, chop, gather) or that it is still locked. A pictogram is a verb,
 * not an equipped tool — the Pokémon does the work.
 */
export type BubbleKind = 'pick' | 'axe' | 'hand' | 'lock'
